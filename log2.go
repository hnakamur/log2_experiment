...
func ILog2B(x uint64) int {
	f := float64(x)
	v := math.Float64bits(f)
	return int(v)>>52 - 1023
}
...
func Log2ByAvernar(n uint64) int {
	n |= n >> 1
	n |= n >> 2
	n |= n >> 4
	n |= n >> 8
...
// Ported from https://stackoverflow.com/a/23000588/1391518
func Log2ByAvernarU8(n uint64) int {
	n |= n >> 1
	n |= n >> 2
	n |= n >> 4
	n |= n >> 8
	n |= n >> 16
	n |= n >> 32
	return int(u8Table[(n*0x03f6eaf2cd271461)>>58])
}

func Log2Double(n uint64) int {
